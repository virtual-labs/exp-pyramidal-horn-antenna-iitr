...
function validate() {
  ...
  var a = document.getElementById('field').innerHTML;
                var b = document.getElementById('coupling').innerText;
              ...
              if(b == null || b == '') {
                Swal.fire({
                 ...
                 width:'480px',
                  ...
                  title:'Missing!',
                  text:'First enter a value for receiving voltage to calculate gain.',     
                  icon:'warning',
                  });
            ...
            if ( isNaN(a) || isNaN(b))
            return false
            if(a==0 && b==-14.81 ||a==10 && b==-15.56 ||a==20 && b==-18.33 ||a==30 && b==-24.35||a==40 && b==-26.85 ||a==50 && b==-22.41||a==60 && b==-18.33||a==70 && b==-14.81||a==80 && b==-24.35||a==90 && b==-30.37||a==360 && b==-14.66||a==350 && b==-15.41||a==340 && b==-18.11||a==330 && b==-23.93||a==320 && b==-26.29||a==310 && b==-22.07||a==300 && b==-18.11||a==290 && b==-14.66||a==280 && b==-23.93||a==270 && b==-29.54  )
          {  var table = document.getElementById("readin");
              
                   
                    var n = xValue.includes(document.getElementById("field").innerHTML)
                    if(n==false){

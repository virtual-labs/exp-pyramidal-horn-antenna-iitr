   ...
   var bar1 = document.getElementById('jog_dial_two_meter_inner1');   
          var dialtwo = JogDial(document.getElementById('jog_dial_two'), 
              ...
              .on('mousemove', function(evt){ 
               ...
               {
                d=50
                document.getElementById("volt").innerText=d+ "mV"
                }
               else if(b>=131 && b<=160){
                 d=160
                 document.getElementById("volt").innerText=d+ "mV"
   ...
   Swal.fire({
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      title:'Missing!',
      text:'Enter the value for Transmitting Voltage.',     
      icon:'warning',
      });
  }
  else if(((b>=232 && b<=240) && v1==330) ){
 var c = v1
...
Swal.fire({
 ...
 width:'480px',
  ...
  html:'Click on <b style="color:blue">Print</b> button to get your page (readings and connections).',    
  icon:'info',
  });
